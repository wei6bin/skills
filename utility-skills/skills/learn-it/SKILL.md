...
2. **Spin up a background agent** using the Agent tool to do the actual work. Pass it the full task description.
...
4. **When the background agent reports back**, summarise what it did in plain, simple terms - no technical details, just "what happened and why it matters." You can't see its progress before it reports, so don't describe steps it hasn't told you about.
