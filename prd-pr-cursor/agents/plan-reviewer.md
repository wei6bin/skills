---
name: plan-reviewer
description: Reviews prd-pr plan documents (00–05) for AC coverage, security, slice integrity, and test plan quality. Phase 6 — run two in parallel (AC/security vs tasks/tests).
model: gpt-5.5
---
