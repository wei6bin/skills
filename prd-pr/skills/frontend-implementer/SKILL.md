...
The orchestrator appends a `lean: lite|full` token to your scope, derived from the slice's story-point size. It tunes how hard you enforce the reuse ladder — it never changes what the ACs require:
