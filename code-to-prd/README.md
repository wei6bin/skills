...
| .NET / ASP.NET | Web API/MVC, WCF, Web Forms (`.aspx`) |
| Native mobile | Android (Java/Kotlin), iOS (Swift/Objective-C) |
| Fullstack | Next.js (pages + API), Nuxt (pages + server), Django (views + templates), ASP.NET (Web API + Web Forms) |
