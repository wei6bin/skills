...
tools: ['search/codebase', 'search/usages', 'read', 'write', 'skill']
...
[Required if the feature seeds data, mutates auth secrets, or uses bootstrap accounts. Document a non-destructive recovery path. Omit if none of those apply.]
